...
public class OkHttpClientManager {
    ...
    public class PostDelegate {
        ...
        public void postAsyn(String url, byte[] bodyBytes, final ResultCallback callback, Object tag) {
            postAsynWithMediaType(url, bodyBytes, MediaType.parse("application/octet-stream;charset=utf-8"), callback,
                    tag);
        }
        ...
        public void postAsyn(String url, File bodyFile, final ResultCallback callback, Object tag) {
            postAsynWithMediaType(url, bodyFile, MediaType.parse("application/octet-stream;charset=utf-8"), callback,
                    tag);
        }
         ...
         * 直接将bodyStr以写入请求体
         */
        public void postAsynWithMediaType(String url, String bodyStr, MediaType type, final ResultCallback callback,
                                          Object tag) {
            RequestBody body = null;
            if (!TextUtils.isEmpty(bodyStr)) {
                body = RequestBody.create(type, bodyStr);
            }
            Request request = buildPostRequest(url, body, tag);
            deliveryResult(callback, request);
        }
         ...
         * 直接将bodyBytes以写入请求体
         */
        public void postAsynWithMediaType(String url, byte[] bodyBytes, MediaType type, final ResultCallback callback,
                                          Object tag) {
         ...
         * 直接将bodyFile以写入请求体
         */
        public void postAsynWithMediaType(String url, File bodyFile, MediaType type, final ResultCallback callback,
                                          Object tag) {
...
//			builder.addHeader("Content-Type","application/json");
            builder.addHeader("Accpet-Encoding", "gzip");
    ...
    public class UploadDelegate {
         ...
         */
        public void postAsyn(String url, String fileKey, File file, ResultCallback callback, Object tag)
                throws IOException {
    ...
    public class HttpsDelegate {
        ...
        public void setCertificates(InputStream[] certificates, InputStream bksFile, String password) {
            try {
                ...
                System.setProperty("https.protocols", "TLSv1");//ADD AT 2016/12/26
